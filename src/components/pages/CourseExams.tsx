        ...
        return (
            <div className="flex flex-col items-center justify-center py-16 text-center space-y-4">
                ...
                <div className="space-y-1">
                    <p className="text-[15px] font-medium text-white">Failed to load past exams</p>
    ...
    if (!files || files.length === 0) {
        return (
            <div className="flex flex-col items-center justify-center py-16 text-center space-y-3">
                ...
                <div className="space-y-1">
                    <p className="text-[15px] font-medium text-white">No past exams uploaded yet</p>
                    <p className="text-[13px] text-white/40">Check back later or request past papers be added.</p>
                </div>
            </div>
        );
    }
