...
import { Loader2, AlertCircle, Download, FileText, ExternalLink, ChevronLeft, ChevronRight, ZoomIn, ZoomOut, RotateCw } from "lucide-react";
...
// Point pdfjs worker to CDN — works in both browser and Tauri WebView
...
export default function FileViewer() {
    ...
    // ─── PDF render error (bad file, CORS, etc.) ──────────────────────────────
    if (pdfError) {
        return (
            <div className="h-full flex flex-col items-center justify-center p-8 text-center">
                <div className="w-16 h-16 rounded-2xl bg-red-500/10 flex items-center justify-center mb-4">
