...
import { LayoutDashboard, Users, UserPlus, ArrowRight } from "lucide-react";
...
export default function ModeratorHome() {
    ...
    return (
        <div className="animate-fade-in max-w-3xl mx-auto pb-20">
            ...
            {/* Quick link */}
            <div className="liquid-glass-subtle rounded-xl px-5 py-5 flex flex-col sm:flex-row sm:items-center gap-4">
