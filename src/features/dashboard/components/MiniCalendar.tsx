        ...
        <div className="liquid-glass rounded-2xl p-5 space-y-4">
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1">
                    <button
                        ...
                        className="w-11 h-11 lg:w-7 lg:h-7 rounded-lg flex items-center justify-center text-muted-foreground hover:text-foreground/70 hover:bg-foreground/5 transition-all"
            ...
            <div className="grid grid-cols-7 gap-0.5 text-center">
                {["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"].map(d => (
                    <div key={d} className="text-[10px] font-display font-semibold text-muted-foreground/50 py-1">{d}</div>
                ))}
            </div>
                    ...
                    return (
                        <button
                            ...
                            className={`relative w-full aspect-square rounded-lg flex items-center justify-center text-[12px] transition-all ${isSelected
                                ? "bg-blue-500 text-foreground font-semibold shadow-[0_0_12px_rgba(37,99,235,0.4)]"
                                : isTodayDate
