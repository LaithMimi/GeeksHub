...
export const fileRequests: FileRequest[] = [
  ...
  { id: "req3", userId: "u1", uploaderName: "John Doe", title: "Calculus Cheat Sheet.pdf", type: "Notes", lecturerName: "Prof. Johnson", lecturerId: "l2", createdAt: "2024-12-20T14:00:00Z", status: "approved", pointsAwarded: 25, reviewedAt: "2024-12-21T10:00:00Z", reviewedById: "admin1", courseId: "math201", fileId: "126" },
  { id: "req4", userId: "u1", uploaderName: "John Doe", title: "Physics Lab Data.xlsx", type: "Homeworks", lecturerName: "Dr. Emily Davis", lecturerId: "l3", createdAt: "2024-12-22T11:00:00Z", status: "approved", pointsAwarded: 15, reviewedAt: "2024-12-23T09:00:00Z", reviewedById: "admin1", courseId: "phys101", fileId: "127" },
